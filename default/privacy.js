...
ready(function()
{
    ...
    else
    {
        ...
        e2.innerHTML = "";
        elem.style.cssText = 'position:fixed;top:' + new_y + 'px;left:' + new_x + 'px;width:327px;height:327px;z-index:100;background:#27263500;border-radius:50%;transform:rotate(-20deg);color:white;font-size:18px;filter:blur(20px)';
